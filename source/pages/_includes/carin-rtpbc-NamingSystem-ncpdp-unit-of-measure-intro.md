This NamingSystem resource represents the proprietary National Program for Prescription Drug Programs (NCPDP) **Unit of Measure (600-28)** code set--enabling it to be referenced within this guide. 
