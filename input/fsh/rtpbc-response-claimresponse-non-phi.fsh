...
* item.extension contains $rtpbc-relatedCoverage named relatedCoverage 0..* MS
* item.extension[relatedCoverage] ^short = "Related Coverage (Extension)"
* item.extension[relatedCoverage] ^definition = "This extension conveys the coverage associated with an RTPBC Response item or addItem."
* item.extension[relatedCoverage] ^isModifier = false
...
* addItem.extension contains $rtpbc-relatedCoverage named relatedCoverage 0..* MS
* addItem.extension[relatedCoverage] ^short = "Related Coverage (Extension)"
* addItem.extension[relatedCoverage] ^definition = "This extension conveys the coverage associated with an RTPBC Response item or addItem."
* addItem.extension[relatedCoverage] ^isModifier = false
