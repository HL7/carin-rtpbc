...
* careTeam.provider.extension.valueCode = #unknown
* careTeam.provider.display = "Not specified"
* insurance.sequence = 1
* insurance.focal = true
* insurance.coverage.extension.url = "http://hl7.org/fhir/StructureDefinition/data-absent-reason"
* insurance.coverage.extension.valueCode = #unknown
* insurance.coverage.display = "Not specified"
* item.sequence = 1
